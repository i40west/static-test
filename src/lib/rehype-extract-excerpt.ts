// This is from: https://github.com/jrson83/rehype-extract-excerpt (MIT license)
// Modified to work with Astro by putting the data under astro.frontmatter.
...
const rehypeExtractExcerpt: Plugin<[RehypeExtractExcerptOptions?], Root> = (
	...
	return (tree, vfile) => {
		...
		vfile.data.astro.frontmatter[options.name!] = excerpt[0];
	};
};
